...
export default function Code() {
    return (
        <div>
            ...
            <div>
                <h2>Whip It</h2>
                <p>Tech: React front-end, Flask/Flask-SQLAlchemy back-end</p>
                <Link to="http://www.whip-it.us" target="_blank" rel="noopener noreferrer">
            ...
            <div>
                <h2>Easy CRM</h2>
                <p>Tech: Flask/Flask-SQLAlchemy</p>
